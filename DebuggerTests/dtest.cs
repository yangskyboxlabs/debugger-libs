...
{
    [TestFixture]
    public class Dtest : DebuggerTests
    {
        ...
        class ReusableBreakpoint
        {
            ...
            public void Continue()
            {
                ...
                finally
                {
                    if (!survived)
                    {
                        // Ensure cleanup if we triggered an assert
                        Disable();
                    }
                }
            }
        ...
        [Test]
        public void ResettingBreakpoint()
        {
            Event e = run_until("breakpoints");

            MethodMirror breakpointsMirror = entry_point.DeclaringType.GetMethod("breakpoints");

            /* Place a breakpoint on bp3 */
            vm.SetBreakpoint(breakpointsMirror, 1);

            vm.Resume();

            e = GetNextEvent();
            Assert.AreEqual(EventType.Breakpoint, e.EventType);
            Assert.AreEqual(breakpointsMirror.Name, (e as BreakpointEvent).Method.Name);

            /* Place a breakpoint on bp1 */
            var bp3Breakpoint = vm.SetBreakpoint(breakpointsMirror, breakpointsMirror.Locations[4].ILOffset);
            bp3Breakpoint.Disable();
            vm.SetBreakpoint(breakpointsMirror, breakpointsMirror.Locations[4].ILOffset);
...
//		}
        ...
        public void Object_SetValues()
        {
            ...
            Assert.IsInstanceOf(typeof(StructMirror), f);
        ...
        public void TypeInfo()
        {
            ...
            foreach (var attr in attrs)
            {
                if (attr.Constructor.DeclaringType.Name == "DebuggerDisplayAttribute")
                {
                    ...
                    Assert.IsInstanceOf(typeof(TypeMirror), attr.NamedArguments[1].TypedValue.Value);
                ...
                {
                    Assert.AreEqual(1, attr.ConstructorArguments.Count);
                    Assert.IsInstanceOf(typeof(TypeMirror), attr.ConstructorArguments[0].Value);
        ...
        public void FieldInfo()
        {
            ...
            Assert.AreEqual(1, attr.ConstructorArguments.Count);
            Assert.IsInstanceOf(typeof(EnumMirror), attr.ConstructorArguments[0].Value);
        ...
        public void AssemblyInfo()
        {
            ...
            Assert.AreEqual("dtest-app, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", aname.ToString());
        ...
        public void LocalsInfo()
        {
            ...
            Assert.AreEqual(10, locals.Length);
            for (int i = 0; i < 10; ++i)
            {
                ...
                else if (locals[i].Name == "b")
                {
                    Assert.IsFalse(locals[i].IsArg);
                    Assert.AreEqual("Double", locals[i].Type.Name);
                }
                else
                {
                    Assert.Fail(locals[i].Name);
                }
            }
        ...
        [Test]
        public void LocalsShared()
        {
            var be = run_until("locals7");
            ...
            // Test that locals are initialized
            var frame = e.Thread.GetFrames()[0];
            var val = frame.GetValue(frame.Method.GetLocal("t"));
            AssertValue(0, val);
        ...
        public void Exit()
        {
            ...
            var e = GetNextEvent();
            Assert.IsInstanceOf(typeof(VMDeathEvent), e);
        ...
        public void Dispose()
        {
            ...
            var e = GetNextEvent();
            Assert.IsInstanceOf(typeof(VMDisconnectEvent), e);
        ...
        public void ColumnNumbers()
        {
            ...
            Assert.AreEqual(9, l.ColumnNumber);
        ...
        public void AssemblyLoad()
        {
            ...
            e = GetNextEvent();
            Assert.IsInstanceOf(typeof(AssemblyLoadEvent), e);
        ...
        public void Invoke()
        {
            ...
            v = this_obj.InvokeMethod(e.Thread, m, null);
            Assert.IsInstanceOf(typeof(StructMirror), v);
            ...
            Assert.IsInstanceOf(typeof(ObjectMirror), v);
        ...
        public void Threads()
        {
            ...
            e = GetNextEvent();
            Assert.IsInstanceOf(typeof(ThreadStartEvent), e);
            ...
            e = GetNextEvent();
            Assert.IsInstanceOf(typeof(ThreadDeathEvent), e);
            Assert.AreEqual(ThreadState.Stopped, e.Thread.ThreadState);
        }

        [Test]
        public void ThreadNameWorks()
        {
            run_until("threads");

            vm.EnableEvents(EventType.ThreadStart, EventType.ThreadDeath);

            //Since we're running in deferred mode, events will be kicked off for existing threads
            vm.EmptyEventQueue();

            vm.Resume();

            var e = GetNextEvent();
            Assert.AreEqual("Test Thread Name", e.Thread.Name);
        }
        ...
        public void Frame_SetValue()
        {
            ...
            // double from int
            var d = frame.Method.GetLocal("b");
            frame.SetValue(d, vm.CreateValue(42));
            AssertValue(42, frame.GetValue(d));
        ...
        public void Exceptions()
        {
            ...
            e = GetNextEvent();
            Assert.IsInstanceOf(typeof(ExceptionEvent), e);
            ...
            vm.Resume();
            e = GetNextEvent();
            Assert.IsInstanceOf(typeof(StepEvent), e);
            frames = e.Thread.GetFrames();
            Assert.AreEqual("exceptions", frames[0].Method.Name);
            sreq.Disable();
        ...
        [Test]
        [Ignore("We need to investigate this test.")]
        ...
        public void Domains()
        {
            ...
            e = GetNextEvent();
            Assert.IsInstanceOf(typeof(AppDomainCreateEvent), e);
            ...
            Assert.IsInstanceOf(typeof(AppDomainUnloadEvent), e);
        ...
        public void RefEmit()
        {
            ...
            Assert.IsInstanceOf(typeof(MethodMirror), ins.Operand);
        ...
        public void UnhandledException_2()
        {
            ...
            Start("unhandled-exception-endinvoke");
        ...
        public void UnhandledExceptionUserCode()
        {
            ...
            Start(@"C:\projects\vscode-unity-debug\debugger-libs\DTestApp\bin\Debug\dtest-app.exe", "unhandled-exception-user");
        ...
        {
            TearDown();
            Start(true, @"C:\projects\vscode-unity-debug\debugger-libs\DTestApp\bin\Debug\dtest-app.exe", "wait-one");
            ...
            //Assert.AreEqual(wait_one_this, local_0, "#14.2"); TODO
        }
        ...
        {
            TearDown();
            Start(@"C:\projects\vscode-unity-debug\debugger-libs\DTestApp\bin\Debug\dtest-app.exe", "threadpool-io");
        ...
        {
            Event e = run_until("nested_exceptions");
            ...
            //Make sure we can't see the hidden if block boolean variables from the debugger
            var locals = frame.Method.GetLocals();
            var values = frame.GetValues(locals);
            Assert.AreEqual(5, locals.Length);
            for (int i = 0; i < 5; ++i)
            {
                if (locals[i].Name == "level")
                {
                    Assert.IsTrue(locals[i].IsArg);
                    Assert.AreEqual("Int32", locals[i].Type.Name);
                    Assert.AreEqual(0, (values[i] as PrimitiveValue).Value);
                }
                else if (locals[i].Name == "message")
                {
                    Assert.IsFalse(locals[i].IsArg);
                    Assert.AreEqual("String", locals[i].Type.Name);
                    Assert.AreEqual("level0", (values[i] as StringMirror).Value);
                }
                else if (locals[i].Name == "ex" && i == 2)
                {
                    Assert.IsFalse(locals[i].IsArg);
                    Assert.AreEqual("Exception", locals[i].Type.Name);
                    Assert.IsNull((values[i] as PrimitiveValue).Value);
                }
                else if (locals[i].Name == "ex")
                {
                    Assert.IsFalse(locals[i].IsArg);
                    Assert.AreEqual("Exception", locals[i].Type.Name);
                    Assert.AreEqual("Exception", (values[i] as ObjectMirror).Type.Name);
                }
                else if (locals[i].Name == "ex2")
                {
                    Assert.IsFalse(locals[i].IsArg);
                    Assert.AreEqual("Exception", locals[i].Type.Name);
                    Assert.IsNull((values[i] as PrimitiveValue).Value);
            ...
            object val = frame.GetValue(frame.Method.GetLocal("message"));
            AssertValue("level0", val);

            //step to nested catch
            e = step_over();
            e = step_over();
            ...
            frame = e.Thread.GetFrames()[0];
            val = frame.GetValue(frame.Method.GetLocal("message"));
            AssertValue("catch", val);
            req.Disable();

            e = run_until("nested_exceptions");
            req.Enable();
            ...
            frame = e.Thread.GetFrames()[0];
            val = frame.GetValue(frame.Method.GetLocal("message"));
            AssertValue("level1", val);

            req.Disable();
        }

        [Test]
        [Ignore("NotWorking: Uses a fixed port")]
        public void Attach()
        {
            vm.Exit(0);

            // Launch the app using server=y,suspend=n
            var pi = CreateStartInfo(new[]
            {
                "--debugger-agent=transport=dt_socket,address=127.0.0.1:10000,server=y,suspend=n",
                @"C:\projects\vscode-unity-debug\debugger-libs\DTestApp\bin\Debug\dtest-app.exe",
                "attach"
            });
        ...
        {
            return @"C:\projects\vscode-unity-debug\debugger-libs\DTestApp\bin\Debug\dtest-app.exe";
        }

        protected override string SourceFilePath()
        {
            return @"C:\projects\vscode-unity-debug\debugger-libs\DTestApp\dtest-app.cs";
        }
    } // class DebuggerTests
} // namespace
