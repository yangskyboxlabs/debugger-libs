...
namespace Mono.Debugger.Soft
{
    public class StackFrame : Mirror
    {
        ...
        {
            get { return Location.SourceFile; }
        }

        public int ILOffset
        {
            get { return Location.ILOffset; }
        }

        public int LineNumber
        {
            get { return Location.LineNumber; }
        }

        public int ColumnNumber
        {
            get { return Location.ColumnNumber; }
        }

        public int EndLineNumber
        {
            get { return Location.EndLineNumber; }
        }

        public int EndColumnNumber
        {
            get { return Location.EndColumnNumber; }
        }
