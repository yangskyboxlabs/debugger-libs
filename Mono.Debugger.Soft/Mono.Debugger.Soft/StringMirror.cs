...
namespace Mono.Debugger.Soft
{
    public class StringMirror : ObjectMirror
    {
        ...
        internal StringMirror(VirtualMachine vm, long id)
            : base(vm, id)
        {
            length = -1;
        }

        internal StringMirror(VirtualMachine vm, long id, TypeMirror type, AppDomainMirror domain)
        ...
        public string Value
        {
            get { return vm.conn.String_GetValue(id); }
        }
