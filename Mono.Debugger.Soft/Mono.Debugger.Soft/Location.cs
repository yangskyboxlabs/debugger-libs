...
namespace Mono.Debugger.Soft
{
    public class Location : Mirror
    {
        ...
        internal Location(VirtualMachine vm, MethodMirror method, long native_addr, int il_offset, string source_file, int line_number, int column_number, int end_line_number, int end_column_number, byte[] hash)
            : base(vm, 0)
        {
            this.method = method;
