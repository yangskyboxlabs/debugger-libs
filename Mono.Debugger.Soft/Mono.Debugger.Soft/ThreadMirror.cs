...
namespace Mono.Debugger.Soft
{
    public class ThreadMirror : ObjectMirror
    {
        ...
        internal ThreadMirror(VirtualMachine vm, long id)
            : base(vm, id) { }

        internal ThreadMirror(VirtualMachine vm, long id, TypeMirror type, AppDomainMirror domain)
        ...
        public long TID
        {
            get { return vm.conn.Thread_GetTID(id); }
        }
         ...
         * frames.
         */
        public static bool NativeTransitions { get; set; }
